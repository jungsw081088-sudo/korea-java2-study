...
public class ObjectStudent {
    ...
    // Object 클래스의 toString(): 클래스풀네임 + @ + 해시코드
    // 오버라이딩해서 객체의 상태(필드값) 정보를 문자열로 표현
    // 하게끔 재정의 - 로깅목적, 디버깅목적
    ...
    public boolean equals(Object o) {
        // 모든 참조자료형은 Object를 상속받고 있음
        // 매개변수로 Object를 전달받으면 모든 참조자료형이
        // 업캐스팅된 상태로 넘어올 수 있다.
    ...
    // equals()를 오버라이딩하면, 반드시 hashCode() 오버라이딩 해야한다.
    // HashSet 등 해시기반 자료형에서 중복처리할때 사용됨
    @Override
    public int hashCode() {
