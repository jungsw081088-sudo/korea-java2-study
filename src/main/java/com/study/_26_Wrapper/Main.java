...
public class Main {
    public static void main(String[] args) {
        /*
            ...
            scores[4]값이 0인데, 초기화가 안된건지? 실제 0점인건지?
            // -> 초기화안된걸 null로 통일하고 싶은데
        */

        // int를 감싸는 래핑클래스
        // 원시자료형을 래퍼클래스로 대입 -> 박싱
        Integer integer1 = Integer.valueOf(90);
        Integer integer2 = 90; // 컴파일러가 알아서

        // char 감싸는 래퍼클래스
        Character c = 'A';

        // Integer, Character 제외하면
        // 앞글자가 대문자인게 해당 원시자료형의 래핑클래스
        Boolean boolean1 = true; // 오토박싱
        Long long1 = 10L; // 오토박싱

        // 객체 -> 메서드사용, 모든 클래스는 Object상속
        // == 연산자 x
        Integer a = 1000;
        Integer b = 1000;
        ...
        // -128 ~ 127 를 필드로 가진 Integer객체는
        // 캐싱이 되어있음.
        Integer test1 = 100;
        Integer test2 = 100;
        System.out.println(test1 == test2); // 같은객체->true
        ...
        // number - 40 -> 양수 -> +1리턴
        // number - 50 -> 0 -> 0리턴
        int result = number.compareTo(60);
