...
public class MapMain {
    public static void main(String[] args) {
        // Map - 추상체 / HashMap - 구현체
        // Map<Key의자료형, Value의자료형>
        // Array, ArrayList - 데이터를 숫자(인덱스)로 관리
        // Map - 데이터를 key로 관리하겠다.
        // key로 관리하다보니 arrayList에 비해 상대적으로 무겁다
        Map<String, Integer> studentMap = new HashMap<>();
        // 제너릭타입은 런타임때 Object가 됨
        // -> 원시자료형은 제너릭타입으로 선언이 불가능
        ...
        */
        ...
        myMap.put(st1, 90);
        myMap.put(st2, 80);
        // hashcode, equals의 구현에 따라 중복여부가 갈린다
        ...
        */
        ...
        // 2. key-value쌍을 한번에 Set으로 바꿔서 순회
        // { {}, {}, {}, ..{} }
        ...
        // 두 방법 모두 데이터가 적을때(만개 이하)는 비슷
        // 방법1) keySet() + .get() -> 해시탐색을 여러번
        // 방법2) entrySet() -> 해시탐색 1회로 key, value모두 접근
        // 수만개 데이터기준으로 20~30퍼 차이가 남
