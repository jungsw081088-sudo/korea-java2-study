...
public class LambdaMain {
    ...
    public static void main(String[] args) {
        /*
            ...
            - 자바는 메서드만 단독으로 존재할 수 x
            - 메서드가 객체가 되면 됨
            -> 메서드 하나만 가지는 객체를 만들면 되겠네?

            // 필드값 필요x,
            메서드를 값처럼 변수에 할당 -> 익명클래스
            -> 인터페이스에 메서드 하나 정의하고 쓰면 되겠다
        */

        // add는 익명클래스 객체 - 업캐스팅되어 있음
...
//            }
        ...
        // 생략가능한 모든걸 생략가능
        // 매개변수 타입 특정됨 -> 생략
        // 한줄리턴(화살표 다음에 중괄호 생략) 가능하면 return 생략
        Calculator lambdaAdd2 = (n1, n2) -> n1 + n2;

        // 람다로 메서드를 정의한 익명객체를 넘긴다
        calcNum(10, 5, lambdaAdd2);

        // 인라인으로 정의를 한다
        // calcNum 메서드는 Calculator 인터페이스 타입의 매개변수를 받음
        // 익명객체를 넘길 수 있음!
        // 변수에 담는게 아니라, 매개변수 자리에 인라인으로 정의 및 생성
